      ...
      <div className="container">
        ...
        <div className="flex justify-center items-center pb-5">
          <div className="grid grid-cols-1 md:grid-cols-2 ">
            <ServiceCard
              icon1={<SiWebcomponentsdotorg size={20} color="cyan" />}
            ...
            />
            <ServiceCard
              icon1={<FaMobileScreen size={30} color="cyan" />}
              icon2={<IoArrowForward size={20} />}
            ...
            />{" "}
            <ServiceCard
              icon1={<IoIosCloudOutline size={30} color="cyan" />}
              icon2={<IoArrowForward size={20} />}
            ...
            />{" "}
            <ServiceCard
              icon1={<SiDigitalocean size={20} color="cyan" />}
              icon2={<IoArrowForward size={20} />}
            ...
            />
            <ServiceCard
              icon1={<SiStartrek size={30} color="cyan" />}
              icon2={<IoArrowForward size={20} />}
